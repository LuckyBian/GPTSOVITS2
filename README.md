...
### Calculate the SISDR Score

```
python get_sisdr.py
```

| Audio File | SI-SDR (dB)                |
|------------|----------------------------|
| 1.wav      | -42.636985778808594        |
| 2.wav      | -40.48308849334717         |
| 3.wav      | -41.818718910217285        |
| 4.wav      | -48.6745548248291          |
| 5.wav      | -51.53432846069336         |
| 6.wav      | -41.37519836425781         |
| 7.wav      | -48.10399055480957         |
