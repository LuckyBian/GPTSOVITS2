...
if __name__ == "__main__":
    ...
    parser.add_argument("--asr_inp_dir", type=str,default="/home/weizhenbian/mycode/data/cut")
    parser.add_argument("--asr_opt_dir", type=str,default="/home/weizhenbian/mycode/data/asr")
